...
A separate full-resolution tweening probe feeds whole-degree readings held for 100 ms into the production motion estimator, polls at 60 Hz, and tags each actual presented drawable with its rendered angle. On the same Mac, the final version presented 116.52 fps. All 417 measured frame pairs with unchanged sensor readings advanced through intermediate angles, with no backward steps during steady closing or opening. The 15°/second trajectory had 0.368° RMS tracking error; the median frame step was 0.1246°. Focused checks also cover 30°/second and 60°/second motion, presentation lead, report timing jitter, noise, reversals, and stops. Prediction is capped at 8°; an abrupt stop between device updates can briefly overshoot, then settles to the held reading within 250 ms.
